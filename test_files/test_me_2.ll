...
if.else:                                          ; preds = %term.bypass
  ...
  %check_canary17 = add i32 323, 135
...
return:                                           ; preds = %term.bypass29, %term.bypass14
  ...
  %check_canary32 = add i32 927, 781
...
if.else:                                          ; preds = %term.bypass
  %canary11 = add i32 323, 135
  store i32 1, i32* %retval, align 4
  %check_canary12 = add i32 323, 135
